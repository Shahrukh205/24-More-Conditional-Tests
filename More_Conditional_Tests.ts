...
// Numerical tests involving equalityy
...
// Tests using "and" opearator
console.log("And opearator test: ", 5===5 && 10 >5);
// Test using "or" opearator
console.log("or opearator test: ", 5===5 || false);
